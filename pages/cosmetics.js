  ...
  return (
    <div className="flex flex-col justify-between w-full h-full min-h-screen">
      <Head>
        ...
        <meta property="og:title" content="Cosmetics - Eternals Capes" />
        <meta property="og:description" content="Check our awesome cosmetics." />
        <meta property="og:url" content="https://eternalscapes.com/cosmetics" />
        ...
        <title>Cosmetics - Eternals Capes</title>
      </Head>
      <div className="container mt-12 mb-auto">
        <h3 className="text-3xl font-bold text-gray-100">Eternals Cosmetics</h3>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
          {res.map((item) => {
            return (
              <CosmeticSearch
                url={`https://api.eternalscapes.com/assets/preview/cosmetics/${item.id}.png`}
                cosmetic={item}
              />
            );
          })}
